...
def prepare_environment():
    torch_index_url = os.environ.get('TORCH_INDEX_URL', "https://download.pytorch.org/whl/cu118")   # Was originally 121, changed to 118 by Jason for xformers compatibility.
    torch_command = os.environ.get('TORCH_COMMAND', f"pip install torch==2.1.2 torchvision==0.16.2 xformers=0.0.23.post1 --extra-index-url {torch_index_url}")
    if args.use_ipex:
